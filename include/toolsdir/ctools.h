...
extern void fill (register char *, register char , register int );

  /* char *addr, ch; int n; */
  /* copies ch into n consecutive bytes. */
  /* return value undefined.  Use only as procedure. */

extern int to_upper_if_lower (char );

  /* char ch;  Returns possibly upper-cased value. */

extern int to_lower_if_upper (char );

  /* char ch;  Returns possibly lower-cased value. */

extern void buffconcat (char *,char *,char *);
...
extern int nbuffconcat (char *, int , char *, char *, char *, char *, char *, char *);
...
extern char *strncfind(register char *, char *, Bool);
...
extern char *strsearch(register char *, register char *, register int , register int);
...
extern char *strncsearch(register char *, register char *, register int , register int );
...
extern int remove_excess_blanks (char *, char *);
...
extern int mygetline (FILE*, char*, int);
